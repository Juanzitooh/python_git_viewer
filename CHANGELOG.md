...
- Contrato de arquitetura foi formalizado em `docs/ARCHITECTURE.md`: `viewer/core` permanece Python puro e desacoplado de UI; adicionada validacao automatica em `tests/test_architecture_contracts.py`.
