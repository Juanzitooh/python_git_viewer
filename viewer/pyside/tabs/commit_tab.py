...
def build_commit_tab(window: object) -> None:
    ...
    window.commit_files_list.itemDoubleClicked.connect(window._on_commit_file_double_clicked)
    ...
    window.commit_diff_view.itemDoubleClicked.connect(window._on_commit_diff_item_double_clicked)
